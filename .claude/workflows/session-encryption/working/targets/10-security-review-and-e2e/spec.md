...
Write a pass report to `.claude/workflows/session-encryption/working/pass-reports/10-security-review-and-e2e.md` that includes:
...
Pass 09 (session-start reconciliation repair) must be complete.
