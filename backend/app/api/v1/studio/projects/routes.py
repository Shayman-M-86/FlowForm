...
from app.api.v1.studio.projects import project_service, studio_projects_bp
...
@studio_projects_bp.route("", methods=["GET"])
@auth.require_auth()
def list_projects():
...
@studio_projects_bp.route("", methods=["POST"])
@auth.require_auth()
def create_project():
...
@studio_projects_bp.route("/<bint:project_id>", methods=["GET"])
@auth.require_auth()
...
@studio_projects_bp.route("/<bint:project_id>/my-permissions", methods=["GET"])
@auth.require_auth()
...
@studio_projects_bp.route("/<bint:project_id>", methods=["PATCH"])
@auth.require_auth()
...
@studio_projects_bp.route("/<bint:project_id>", methods=["DELETE"])
@auth.require_auth()
