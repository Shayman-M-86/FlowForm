...
from sqlalchemy import CheckConstraint, LargeBinary, SmallInteger, Text, UniqueConstraint, func
...
class ResponseEnvelope(ResponseBase):
    ...
    __table_args__ = (
        ...
        CheckConstraint("octet_length(wrapped_dek) > 0", name="wrapped_dek_len"),
