...
| `infra/containers/`                                                          | Container assets split by ownership: shared images and runtime definitions, plus AWS, dev, and rehearsal strategies. | `infra/containers/images/`, `infra/containers/runtime/`, `infra/containers/strategies/`                                     |
...
| `infra/images/`                                                             | Packer machine-image construction: shared AWS/Proxmox golden builds, bounded Proxmox LocalStack and PostgreSQL fixtures, one image dispatcher, and the image contract. | `infra/images/README.md`, `infra/images/packer/README.md`, `infra/images/IMAGE-CONTRACT.md`                                 |
