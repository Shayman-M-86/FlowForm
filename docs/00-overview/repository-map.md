...
| `infra/images/`                                                             | Packer machine-image construction: shared AWS/Proxmox golden builds, bounded Proxmox LocalStack and PostgreSQL fixtures, build scripts, and the image contract. | `infra/images/packer/README.md`, `infra/images/scripts/`, `infra/images/IMAGE-CONTRACT.md`                                  |
