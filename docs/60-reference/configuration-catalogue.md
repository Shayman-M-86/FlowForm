...
| Development container environment | `infra/containers/strategies/dev/compose/compose.yml`                                                                                                                | Integrated local and local-proof container configuration.                                    |
| Test container environment     | `infra/containers/strategies/dev/compose/compose.test.yml`, `infra/containers/strategies/dev/services/backend/`                                                       | Test-only Compose stack and Dockerfile.                                                       |
...
| Runtime container deployment   | `infra/containers/runtime/`, `infra/containers/strategies/aws/services/`, `infra/deployment/proxmox/cloud-init/templates/`                                            | Shared runtime Compose, AWS service configuration, and cloud-init templates.                  |
...
| Rehearsal environment          | `infra/containers/strategies/rehearsal/`                                                                                                                             | Rehearsal proxy override, dedicated DB Compose, services, and fixture configuration.         |
...
| Packer image build             | `infra/images/packer/**/*.pkr.hcl`, `infra/images/packer/variables/*.pkrvars.hcl.example`, `infra/images/config/proxmox-source.env.example`                     | Shared golden and Proxmox fixture definitions plus local examples for source preparation and selected builds. |
...
| `infra/images/config/proxmox-source.env.example` | Local source-template preparation configuration. |
| `infra/deployment/proxmox/terraform/terraform.tfvars.example` | Local Terraform deployment configuration. |
| `infra/deployment/proxmox/cloud-init/templates/*.yaml.tftpl` | Terraform-rendered Proxmox cloud-init payloads. |
