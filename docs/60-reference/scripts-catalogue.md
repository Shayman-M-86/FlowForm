...
| Image validation        | `infra/tests/images/validate.sh`, `infra/tests/images/test-prepare-proxmox-source.sh`, `infra/images/scripts/verify-proxmox-disk-sizes.sh`       | Packer syntax, source preparation, and live Proxmox disk-limit checks.  |
