...
| Packer image build      | `infra/images/scripts/*.sh`, `infra/images/packer/provisioners/`                                                                                | Source preparation, selected AWS/Proxmox builds, fixture preload, and AMI publication. |
| Image validation        | `infra/tests/images/validate.sh`, `infra/tests/images/test-prepare-proxmox-source.sh`, `infra/images/scripts/verify-proxmox-disk-sizes.sh`, `infra/images/scripts/verify-aws-ami.sh` | Packer syntax, source preparation, live Proxmox disk limits, and AWS AMI/snapshot checks. |
