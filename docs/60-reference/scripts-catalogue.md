...
| CDK support             | `infra/scripts/cdk/seed-secrets.sh`                                                                                                               | CDK environment seeding helper.                                         |
| Image building          | `infra/images/provisioning/**/*.sh`, `infra/images/manifests/extract-aws-ami-id.sh`                                                               | Packer provisioning helpers and AMI-manifest extraction.                |
...
| Proxmox orchestration   | `infra/proxmox/*.sh`, `infra/proxmox/lib/template-build.sh`                                                                                       | Current Proxmox host, VM, user-data, and compatibility-wrapper helpers. |
| Rehearsal templates     | `infra/rehearsal/proxmox/*.sh`, `infra/rehearsal/proxmox/lib/template-build.sh`                                                                   | Rehearsal-specific template creation helpers.                           |
...
The shared frontend package manifests and `infra/cdk/package.json` currently define no `scripts` entries.
