...
| Databases | `DATABASE_CORE_*`, `DATABASE_RESPONSE_*`, including `*_AUTH_MODE` | Backend settings, bootstrap, and Compose |
...
| Bootstrap | `FLOWFORM_DEPLOYMENT_TARGET`, `FLOWFORM_SCOPE`, `AWS_REGION`, `BOOTSTRAP_*`, `FLOWFORM_SECRET_DIR` | Bootstrap script headers |
