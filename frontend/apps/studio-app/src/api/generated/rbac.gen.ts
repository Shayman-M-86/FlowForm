...
export const routePermissions: RoutePermissionEntry[] = [
  ...
  { method: "GET", pattern: /^\/api\/v1\/projects\/(?<project_id>[^\/]+)\/participants$/, permission: "project:manage_members", paramNames: ["project_id"] },
  { method: "POST", pattern: /^\/api\/v1\/projects\/(?<project_id>[^\/]+)\/participants$/, permission: "project:manage_members", paramNames: ["project_id"] },
  { method: "PATCH", pattern: /^\/api\/v1\/projects\/(?<project_id>[^\/]+)\/participants\/(?<participant_id>[^\/]+)$/, permission: "project:manage_members", paramNames: ["project_id","participant_id"] },
  { method: "DELETE", pattern: /^\/api\/v1\/projects\/(?<project_id>[^\/]+)\/participants\/(?<participant_id>[^\/]+)$/, permission: "project:manage_members", paramNames: ["project_id","participant_id"] },
  ...
  { method: "GET", pattern: /^\/api\/v1\/projects\/(?<project_id>[^\/]+)\/surveys\/(?<survey_id>[^\/]+)\/responses$/, permission: "submission:view", paramNames: ["project_id","survey_id"] },
  { method: "GET", pattern: /^\/api\/v1\/projects\/(?<project_id>[^\/]+)\/surveys\/(?<survey_id>[^\/]+)\/responses\/(?<session_id>[^\/]+)$/, permission: "submission:view", paramNames: ["project_id","survey_id","session_id"] },
  { method: "DELETE", pattern: /^\/api\/v1\/projects\/(?<project_id>[^\/]+)\/surveys\/(?<survey_id>[^\/]+)\/responses\/(?<session_id>[^\/]+)$/, permission: "submission:view", paramNames: ["project_id","survey_id","session_id"] },
  { method: "GET", pattern: /^\/api\/v1\/projects\/(?<project_id>[^\/]+)\/surveys\/(?<survey_id>[^\/]+)\/responses\/(?<session_id>[^\/]+)\/history$/, permission: "submission:view", paramNames: ["project_id","survey_id","session_id"] },
  { method: "POST", pattern: /^\/api\/v1\/projects\/(?<project_id>[^\/]+)\/surveys\/(?<survey_id>[^\/]+)\/responses\/export$/, permission: "submission:view", paramNames: ["project_id","survey_id"] },
