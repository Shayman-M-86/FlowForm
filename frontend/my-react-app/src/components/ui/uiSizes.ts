...
export const textareaSizeClasses: Record<TextareaSize, string> = {
  sm: "min-h-[88px] max-h-[88px] px-3 py-2 text-[0.86rem] leading-6",
  md: "min-h-[120px] max-h-[120px] px-4 py-3 text-sm leading-6",
  lg: "min-h-[168px] max-h-[168px] px-4 py-3 text-base leading-7",
};
