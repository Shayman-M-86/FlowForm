...
# Locate the repository root from this script
# (runtime/proxmox/rehearsal/services/registry -> ../../../../../../..).
# Allow REPO_ROOT override for unusual checkouts.
SCRIPT_DIR="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)"
REPO_ROOT="${REPO_ROOT:-$(cd -- "${SCRIPT_DIR}/../../../../../../.." && pwd)}"
DOCKERFILE="${REPO_ROOT}/infra/containers/images/backend/Dockerfile"
