...
paths — see `infra/containers/runtime/aws/common/compose/proxy.yml` and
...
The production Compose files belong under
`infra/containers/runtime/aws/common/compose/`, as called out in [Phase
2a](core-sketch-plan.md#phase-2--backend-runtime-on-ec2). The proxy
