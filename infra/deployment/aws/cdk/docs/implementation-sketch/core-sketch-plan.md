...
**2a. Production Compose files**
(`infra/containers/runtime/aws/common/compose/`): separate App and Proxy
topologies using immutable images from ECR. No Postgres container;
