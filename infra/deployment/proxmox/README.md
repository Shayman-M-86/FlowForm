...
`create-vms.sh` renders `infra/deployment/proxmox/cloud-init` templates and attaches them
as Proxmox snippets before boot. Environment-specific values and fixtures remain
under `infra/containers/rehearsal`; the rendered cloud-init starts shared
