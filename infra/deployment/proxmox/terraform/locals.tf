locals {
  ...
  cloud_init_template_values = {
    REHEARSAL_CA_CRT_B64                = base64encode(file("${path.module}/../../../containers/runtime/proxmox/rehearsal/services/tls-shim/ca/rehearsal-ca.crt"))
    BOOTSTRAP_APP_SH_B64                = base64encode(file("${path.module}/../../../machine-images/definitions/app/host-assets/bin/bootstrap-app.sh"))
    AWS_CLI_RETRY_SH_B64                = base64encode(file("${path.module}/../../../machine-images/shared/host-assets/bin/aws-cli-retry.sh"))
    BOOTSTRAP_COMMON_SH_B64             = base64encode(file("${path.module}/../../../machine-images/shared/host-assets/bin/bootstrap-common.sh"))
    DOCKER_COMPOSE_APP_B64              = base64encode(file("${path.module}/../../../containers/runtime/aws/common/compose/app.yml"))
    DOCKER_COMPOSE_APP_REHEARSAL_B64    = base64encode(file("${path.module}/../../../containers/runtime/proxmox/rehearsal/compose/app.override.yml"))
    BOOTSTRAP_DB_SH_B64                 = base64encode(file("${path.module}/../../bootstrap/bootstrap-db.sh"))
    DOCKER_COMPOSE_DB_B64               = base64encode(file("${path.module}/../../../containers/runtime/proxmox/rehearsal/compose/db.yml"))
    ...
    BOOTSTRAP_PROXY_SH_B64              = base64encode(file("${path.module}/../../../machine-images/definitions/proxy/host-assets/bin/bootstrap-proxy.sh"))
    DOCKER_COMPOSE_PROXY_B64            = base64encode(file("${path.module}/../../../containers/runtime/aws/common/compose/proxy.yml"))
    DOCKER_COMPOSE_PROXY_REHEARSAL_B64  = base64encode(file("${path.module}/../../../containers/runtime/proxmox/rehearsal/compose/proxy.override.yml"))
    CADDYFILE_PROXY_REHEARSAL_B64       = base64encode(file("${path.module}/../../../containers/runtime/proxmox/rehearsal/services/caddy/Caddyfile.proxy"))
    PROXY_API_CRT_B64                   = base64encode(file("${path.module}/../../../containers/runtime/proxmox/rehearsal/services/caddy/certs/api.crt"))
    PROXY_API_KEY_B64                   = base64encode(file("${path.module}/../../../containers/runtime/proxmox/rehearsal/services/caddy/certs/api.key"))
    SQUID_ALLOWED_DOMAINS_REHEARSAL_B64 = base64encode(file("${path.module}/../../../containers/runtime/proxmox/rehearsal/services/squid/allowed-domains.txt"))
    ...
    LOCALSTACK_CRT_B64                  = base64encode(file("${path.module}/../../../containers/runtime/proxmox/rehearsal/services/tls-shim/ca/localstack.crt"))
    LOCALSTACK_KEY_B64                  = base64encode(file("${path.module}/../../../containers/runtime/proxmox/rehearsal/services/tls-shim/ca/localstack.key"))
