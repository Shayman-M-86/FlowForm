...
declare -A PLACEHOLDERS=(
  ...
  [__PROXY_API_CRT_B64__]="infra/containers/rehearsal/services/caddy/certs/api.crt"
  [__PROXY_API_KEY_B64__]="infra/containers/rehearsal/services/caddy/certs/api.key"
