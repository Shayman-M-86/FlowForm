...
pkg_install ca-certificates curl-minimal ec2-instance-connect jq unzip nftables openssl shadow-utils util-linux-core systemd-networkd \
  || pkg_install ca-certificates curl-minimal ec2-instance-connect jq unzip nftables openssl shadow-utils util-linux-core
