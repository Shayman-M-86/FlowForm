...
declare -A PLACEHOLDERS=(
  ...
  [__CADDYFILE_PROXY_REHEARSAL_B64__]="infra/environments/rehearsal/fixtures/caddy/Caddyfile.proxy"
  [__SQUID_CONF_B64__]="infra/runtime/config/squid/squid.conf"
  [__SQUID_ALLOWED_DOMAINS_REHEARSAL_B64__]="infra/environments/rehearsal/fixtures/squid/allowed-domains.rehearsal.txt"
  [__DOCKER_COMPOSE_LOCALSTACK_B64__]="infra/environments/rehearsal/fixtures/localstack/docker-compose.localstack.yml"
  [__DOCKER_COMPOSE_REGISTRY_B64__]="infra/environments/rehearsal/fixtures/registry/docker-compose.registry.yml"
  [__DOCKER_COMPOSE_TLS_SHIM_B64__]="infra/environments/rehearsal/fixtures/tls-shim/docker-compose.tls-shim.yml"
