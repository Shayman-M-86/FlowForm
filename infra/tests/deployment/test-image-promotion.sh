  ...
  cat > "${TEST_DIR}/release.json" <<'EOF'
{
  ...
  "images": [
    {"name":"backend","target":"reg/flowform-staging-backend:t","digest":"sha256:1111111111111111111111111111111111111111111111111111111111111111"},
    {"name":"caddy","target":"reg/flowform-staging-caddy:t","digest":"sha256:2222222222222222222222222222222222222222222222222222222222222222"},
    {"name":"squid","target":"reg/flowform-staging-squid:t","digest":"sha256:3333333333333333333333333333333333333333333333333333333333333333"},
    {"name":"alloy","target":"reg/flowform-staging-alloy:t","digest":"sha256:4444444444444444444444444444444444444444444444444444444444444444"}
  ]
}
EOF
}
