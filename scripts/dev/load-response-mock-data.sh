...
SECRET_FILE="${SECRET_FILE:-${PROJECT_ROOT}/infra/env/dev/secrets/DATABASE_RESPONSE_INIT_PASSWORD.dev.secret.txt}"
SQL_FILE="${1:-${SQL_FILE:-${PROJECT_ROOT}/infra/database/flowform_response_mock_data.sql}}"
