...
DOCSYS_COMMANDS = {
    ...
    "capabilities": {
        "module": "flowform_tools.docsys.capabilities",
    ...
    "validate-metadata": {
        "module": "flowform_tools.docsys.maintenance.validate_doc_metadata",
        "description": "validate documentation front-matter metadata",
        "access": "read-only",
    },
    "validate-links": {
