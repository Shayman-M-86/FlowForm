...
- required front-matter keys (title, document_type, status, authority,
  verified_evidence_digest, last_edited, aliases, related_code, related_docs)
...
from flowform_tools.docsys.model import related_code_file_error
from flowform_tools.paths import ROOT

DOCS = ROOT / "docs"

REQUIRED = ["title", "document_type", "status", "authority",
            "verified_evidence_digest", "last_edited", "aliases", "related_code",
            "related_docs"]
ALLOWED_STATUS = {"scaffold", "draft", "verified"}
ALLOWED_CONFIDENCE = {"high", "medium", "low"}
# Optional tooling fields (consumed by tools/flowform_tools/docsys/):
